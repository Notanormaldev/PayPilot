...
![PayPilot Dashboard](./frontend/public/paypilot-payrun-dashboard.jpg)
...
- Statutory obligations — EPF, ESI, TDS with drill-down links
...
- Employee Self-Service mini-panel with live shift timer
...
- Leave Requests Queue — Approve / Reject from the HR Manager panel
- Configurable Leave Types (Earned, Casual, Sick, and custom types)
- Fix Missing Punch flow for attendance regularization

### Approvals
Centralized queue for reimbursement claims, investment proofs, salary revisions, and time-off requests.

### Sentinel Audit Engine

PayPilot's flagship differentiator — explainable payroll integrity:

- **25+ active compliance flags** across: Critical & High Risk, Banking & KYC, Payroll Computations, Compliance Rulebook
- **AI Diagnostic Analysis** per flag — plain-language explanation grounded in actual computed numbers
- **Live Payslip Preview** — see the corrected payslip recomputed before resolving
...
- Dynamic Slab-by-Slab Tax Distribution loaded from DB rules
...
![Executive Reports](./frontend/public/paypilot-reports-analytics.png)
...
Visit [http://localhost:5173](http://localhost:5173) and use **1-Click Demo Access** on the login page.
